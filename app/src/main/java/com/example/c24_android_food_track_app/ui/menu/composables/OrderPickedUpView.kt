...
@Composable
fun OrderPickedUpView(order: FoodTrackOrder) = Column(
    modifier = Modifier
        .fillMaxSize()
    ...
    Text(
        text = "We hope you enjoy your meal!",
        modifier = Modifier.fillMaxWidth(),
        textAlign = TextAlign.Center,
...
@Composable
fun OrderPickedUpViewPreview() =
    OrderPickedUpView(createPreviewFoodTrackOrder(status = Status.Picked))
